...
#ifndef CIRCLEPAYSDK_SWIFT_H
#define CIRCLEPAYSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CirclePaySDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12CirclePaySDK15IQBarButtonItem")
...
SWIFT_CLASS("_TtC12CirclePaySDK28IQBarButtonItemConfiguration")
...
SWIFT_CLASS("_TtC12CirclePaySDK12IQInvocation")
...
SWIFT_CLASS("_TtC12CirclePaySDK17IQKeyboardManager")
...
SWIFT_CLASS("_TtC12CirclePaySDK26IQKeyboardReturnKeyHandler")
...
SWIFT_CLASS("_TtC12CirclePaySDK18IQPreviousNextView")
...
SWIFT_CLASS("_TtC12CirclePaySDK10IQTextView")
...
SWIFT_CLASS("_TtC12CirclePaySDK20IQTitleBarButtonItem")
...
SWIFT_CLASS("_TtC12CirclePaySDK9IQToolbar")
...
SWIFT_CLASS("_TtC12CirclePaySDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(CirclePaySDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(CirclePaySDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(CirclePaySDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(CirclePaySDK)) <NSURLSessionTaskDelegate>
...
@interface UIView (SWIFT_EXTENSION(CirclePaySDK))
/// To set customized distance from keyboard for textField/textView. Can’t be less than zero
@property (nonatomic) CGFloat keyboardDistanceFromTextField;
